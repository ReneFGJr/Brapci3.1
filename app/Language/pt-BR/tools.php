...
return [
        ...
        'ARS_txt4net' => 'Converter Texto (.txt) para .net (Pajek)',
        'ARS_txt4matrix' => 'Converter Texto (.txt) para Matriz de Correlação',
        'ARS_txt4count' => 'Extrair e contar lista de autores (.csv)',
        'Options' => 'Parametros',
