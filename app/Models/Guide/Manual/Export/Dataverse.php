...
return $xhtml;
    ...
    function index($id)
    {
        ...
        $sx .= $pause;
        $sx .= 'echo "Copiando Styles"';
        $sx .= '<br>';
        $sx .= 'mkdir $PAYARA/domains/domain1/applications/dataverse/css';
        $sx .= '<br>';
        $sx .= 'cd $PAYARA/domains/domain1/applications/dataverse/css';
        $sx .= '<br>';
        $sx .= 'wget ' . $url . PATH . '/_repository/guide/' . $id . '/guide.css -O guide.css -q' . '</a>';
        $sx .= '<br>';
