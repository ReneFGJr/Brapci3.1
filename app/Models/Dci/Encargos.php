...
class Encargos extends Model
{
    ...
    protected $typeFields    = [
        ...
        'sql:id_di:di_disciplina:(select id_di, concat(di_codigo,\' - \',di_disciplina) as di_disciplina from disciplinas order by di_codigo) as disciplinas  order by di_codigo',
