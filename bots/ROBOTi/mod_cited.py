...
def categorizeCited():
    ...
    for line in row:
        ...
        message += '"Não Identificado" como 0; "Artigos" como 1; "Livro" como 2; '
        message += '"Cap. Livro" como 3; "Anais de eventos" como 5; "Tese" como 7; '
        message += '"Dissertação" como 8; "TCC" como 9; "Link de internet" como 15; '
        message += '"Journal Diário" como 16; "Filme" como 17; '
        message += '"Revista semanal (Entreterimento)" como 18; "Leis" como 20; '
        message += '"Relatórios" como 21; "Normas técnicas" como 22; "Entrevista" como 29; '
        message += '"Software" como 30; "Patentes" como 31; "Base de dados" como 32; '
        message += '"Notas de Pesquisa / Outros" como 97; "Nulo - Null" como -1. '
